...
namespace Ayende
{
	...
	public class Configuration
	{
		...
		/// <summary>
		/// Checks if a specified key is in the class
		/// </summary>
		...
		/// </summary>
		/// <param name="KeyName">The name of the key, the key must exist</param>
		/// <param name="ValueName">The name of the value to check</param>
		/// <returns>Whether the value exists in the key or not</returns>
