...
package com.pixeldroid.r_c4d3.api
{
	...
	@eventtype com.pixeldroid.r_c4d3.api.events.JoyAxisEvent.JOY_AXIS_MOTION 
	*/
	[Event(name="JOY_AXIS_MOTION", type="com.pixeldroid.r_c4d3.api.events.JoyAxisEvent")]
	
	/** 
	Dispatched when a trackball motion occurs.
	@eventtype com.pixeldroid.r_c4d3.api.events.JoyBallEvent.JOY_BALL_MOTION 
	*/
	[Event(name="JOY_BALL_MOTION", type="com.pixeldroid.r_c4d3.api.events.JoyBallEvent")]
	
	/** 
	Occurs when a button on the joystick is pressed or released
	@eventtype com.pixeldroid.r_c4d3.api.events.JoyButtonEvent.JOY_BUTTON_MOTION 
	*/
	[Event(name="JOY_BUTTON_MOTION", type="com.pixeldroid.r_c4d3.api.events.JoyButtonEvent")]
	
	/** 
	Occurs when a button on the joystick is pressed
	@eventtype com.pixeldroid.r_c4d3.api.events.JoyButtonEvent.JOY_BUTTON_DOWN 
	*/
	[Event(name="JOY_BUTTON_DOWN", type="com.pixeldroid.r_c4d3.api.events.JoyButtonEvent")]
	
	/** 
	Occurs when a button on the joystick is released
	@eventtype com.pixeldroid.r_c4d3.api.events.JoyButtonEvent.JOY_BUTTON_UP 
	*/
	[Event(name="JOY_BUTTON_UP", type="com.pixeldroid.r_c4d3.api.events.JoyButtonEvent")]
	
	/** 
	Dispatched when a digital stick (4- or 8-way) motion occurs.
	@eventtype com.pixeldroid.r_c4d3.api.events.JoyHatEvent.JOY_HAT_MOTION
	*/
	[Event(name="JOY_HAT_MOTION", type="com.pixeldroid.r_c4d3.api.events.JoyHatEvent")]
	...
	*/
	public interface IGameControlsProxy extends IEventDispatcher
	{
		...
		*/
		...
		@param state A JoyEventStateEnumerator value (QUERY, ENABLE or IGNORE)
		...
		<p>Note:<i>
		In addition to setting the joystick event state to ENABLE, Event listeners must be added
		in order to receive event notifications.
		</i></p>
		*/
		function joystickEventState(state:JoyEventStateEnumerator, stage:Stage):JoyEventStateEnumerator;
