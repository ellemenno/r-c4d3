...
package
{
	...
	[SWF(width="200", height="50", frameRate="30", backgroundColor="#000000")]
    public class SoundTest extends Sprite
	{
	
		private var colors:Array = [0xff0000, 0x00ffff, 0xffff00, 0x444400];
    ...
    class SoundButton extends Sprite
	{
		...
		private function draw(lineWeight:int, radius:int):void
		{
			...
			graphics.drawRoundRect(0,0, 40,50, radius);
			graphics.endFill();
		}
	}
